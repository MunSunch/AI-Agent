...
Агент доступен только через телеграмм бот @blinchik_for_munir_bot
...
способен выполнять работу, определенную в инструменте, расположенном во внешнем контуре, по протоколу MCP. Проект установлен и функционирует на raspberry pi 5. 

## Архитектура проекта
Вставить диаграммы в c4
	контекст
	контейнер
	контекст(подробнее расписать агента)
